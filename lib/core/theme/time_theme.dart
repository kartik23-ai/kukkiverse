...
class TimeThemeData {
  ...
  static const morning = TimeThemeData(
    ...
    label: 'Morning Dew',
    glassTint: Color(0x440D1B2A),
    glassEdge: Color(0x28DCEEFB),
    accentGlow: Color(0xFF7EC8E3),
    bgDeep: Color(0xFF0F223D),
    bgSurface: Color(0xFF152A4A),
  ...
  static const noon = TimeThemeData(
    phase: DayPhase.noon,
    label: 'Sleek Solar',
    glassTint: Color(0x44111827),
    glassEdge: Color(0x28F5C563),
    accentGlow: Color(0xFFF5A623),
    bgDeep: Color(0xFF141E34),
    bgSurface: Color(0xFF1B2840),
  ...
  static const evening = TimeThemeData(
    ...
    label: 'Golden Hour',
    glassTint: Color(0x441A0E1E),
    glassEdge: Color(0x28FFB07C),
    accentGlow: Color(0xFFFF7B54),
    bgDeep: Color(0xFF22102A),
    bgSurface: Color(0xFF2B1B3A),
  ...
  static const night = TimeThemeData(
    ...
    label: 'Deep Obsidian',
    glassTint: Color(0x4408060E),
    glassEdge: Color(0x20A78BFA),
    accentGlow: Color(0xFF8B5CF6),
    bgDeep: Color(0xFF0F0B24),
    bgSurface: Color(0xFF181134),
